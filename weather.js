...
import {createSkyEnvironment} from './sky-environment.js?v=18.1';
import {surface} from './navigation.js?v=18.1';
...
export function createWeather({scene,courtyard,sun}){
 ...
 let current=null,active='cloud',wind=0,windDirection=0,day=true,lastSeason='',lastRefresh=0,busy=false;
 ...
 return {movingRoots:flags,update(time,dt,camera){skyEnvironment.update(time,camera);
